...
var getConfig = module.exports = function () {
  return {
    ...
    gcloud: {
      projectId: process.env.GCLOUD_PROJECT || 'rot13-wrb'
    },

    // Typically you will create a bucket with the same name as your project ID.
    cloudStorageBucket: process.env.CLOUD_BUCKET || 'rot13-wrb',
    ...
    oauth2: {
      ...
      redirectUrl: process.env.OAUTH2_CALLBACK ||
        'http://pacific-castle-63467.herokuapp.com/oauth2callback',
